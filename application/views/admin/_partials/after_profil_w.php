<div class="col-sm-6">
    <div class="text-right">
        <a href="<?= base_url('walikelas/editprofil')  ?>" class="btn btn-success waves-effect waves-light">
            <i class="mdi mdi-account-settings-variant m-r-5"></i> Ubah Profil
        </a>
        <a href="<?= base_url('walikelas/ubahsandi')  ?>" class="btn btn-success waves-effect waves-light">
                            ...
                            <div class="ribbon-box m-b-30 text-white bg-danger text-xs-center">
                                <div class="card-body">
                                    <blockquote class="card-bodyquote">
                                        ...
                                        <a href="<?= base_url('walikelas/pembayaran') ?>" class="btn btn-outline-light">Lihat Laporan Pembayaran Kas</a>
                                    </blockquote>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="ribbon-box m-b-30 text-white bg-warning text-xs-center">
                                <div class="card-body">
                                    <blockquote class="card-bodyquote">
                                        ...
                                        <a href="<?= base_url('walikelas/laporan') ?>" class="btn btn-outline-light">Lihat Laporan Pengeluaran</a>
                                    </blockquote>
                                </div>
                            </div>
                        </div>
